...
def banner(console):
    ...
    console.print("[bold green]SHADOE[/bold green]: Car Parking Multiplayer Hacking Tool.")
    console.print(f"[bold green]Hào[/bold green]: [bold blue]@{__CHANNEL_USERNAME__}[/bold blue] or [bold blue]@{__GROUP_USERNAME__}[/bold blue].")
